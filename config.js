...
const ANNEX_CONFIG = [
  ...
  {
    id: "annex1",
    title: "विवरणपत्र 1 : वेतन विषयक तपशील",
    type: "fixed",
    summaryKey: "total",
    columns: [
      { key: "sr", label: "अ.क्र.", type: "text", editable: false },
      { key: "baab", label: "बाब", type: "text", editable: false, width: "30%" },
      ...
      { key: "total", label: "एकूण खर्च (actual+expected)", type: "number", editable: false,
      ...
      { key: "reason", label: "कारणे", type: "text", editable: true },
    ],
    rows: [
      { sr: "1", baab: "मूळ वेतन" },
      { sr: "2", baab: "राष्ट्रीय निवृत्ती वेतन (NPS) 14%" },
      { sr: "3 अ", baab: "महागाई भत्ता - मार्च ते ऑक्टोबर हप्ता" },
      { sr: "3 ब", baab: "महागाई भत्ता - नोव्हेंबर ते जानेवारी हप्ता (संभाव्य वाढ)" },
      { sr: "3 क", baab: "महागाई भत्ता - जुलै ते फेब्रुवारी हप्ता (संभाव्य वाढ)" },
      { sr: "", baab: "एकूण महागाई भत्ता (अ+ब+क)" },
      { sr: "4", baab: "घरभाडे भत्ता" },
      { sr: "5", baab: "स्थानिक पूरक भत्ता" },
      { sr: "6", baab: "वाहतूक भत्ता" },
      { sr: "7", baab: "प्रोत्साहन भत्ता" },
      { sr: "8", baab: "10/20/30 वर्षे कालबध्द पदोन्नती भार व लाभार्थी" },
      { sr: "9", baab: "रजा प्रवास सवलत योजना (भार)" },
      { sr: "10", baab: "वैद्यकीय प्रतिपूर्ती" },
      { sr: "11", baab: "थकित देयके (विवरणपत्र 1अ मधील एकूण रक्कम)" },
      { sr: "12", baab: "इतर खर्च" },
      { sr: "", baab: "एकूण", isTotalRow: true },
    ],
  },
  ...
  // ---------------- Annex 2a ----------------
  {
    ...
    rows: [
      ...
      { sr: "अ", baab: "एकूण (अ) दूरध्वनी, वीज, पाणी खर्च", isSubtotal: true },
      { sr: "4", baab: "गॅस खर्च" },
  ...
  // ---------------- Annex 5 ----------------
  {
    ...
    rows: [
      ...
      { sr: "", baab: "एकूण शिक्षण फी व इतर", isSubtotal: true },
      ...
      { sr: "", baab: "एकूण 102 शिक्षण फी व इतर फी", isSubtotal: true },
      ...
      { sr: "", baab: "एकूण प्रौढ शिक्षण व इतर फी", isSubtotal: true },
      ...
      { sr: "", baab: "एकूण 501 सेवा व सेवा फी", isSubtotal: true },
      ...
      { sr: "", baab: "एकूण 600 सर्वसाधारण", isSubtotal: true },
      ...
      { sr: "", baab: "एकूण 800 (01)", isSubtotal: true },
      { sr: "21", baab: "(02)(01) महाराष्ट्र राज्य परीक्षा परिषदेकडून वसुली (02020198)" },
      { sr: "", baab: "एकूण 800 जमा रकमा", isSubtotal: true },
      ...
      { sr: "", baab: "एकूण 801 व्याज किंवा इतर जमा रकमा", isSubtotal: true },
      { sr: "", baab: "एकूण 01 सर्वसाधारण शिक्षण", isTotalRow: true },
    ],
  },
